  ...
  <div class="prodetail">
    ...
    <div class="comment">
      <div class="comment-title">
        <div class="left">商品评价 ({{ totalNumComment }}条)</div>
...
export default {
  ...
  methods: {
    ...
    async getProComment (goodsId, limit) {
      const { data: { list, total } } = await getProCommentReq(goodsId, limit)
  ...
  created () {
    this.getProDetail(this.goodsId)
    this.getProComment(this.goodsId, 2)
  },
