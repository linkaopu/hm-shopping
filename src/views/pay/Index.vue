...
<script>
import { getAddressListReq } from '@/api/address'
import { checkOrder, submitOrderReq } from '@/api/order'
...
export default {
  ...
  methods: {
    async getAddressList () {
      const { data: { list } } = await getAddressListReq()
    ...
    async submitOrder () {
      if (this.mode === 'cart') {
        await submitOrderReq(this.mode, {
          remark: this.remark,
